...
public class VideoFragment extends BaseFragment implements View.OnClickListener, PortMessageReceiver.BroadcastListener {
    ...
    public void onDestroyView() {
        ...
        PortSipSdk portSipLib = application.getMEngine();
        ...
        CallManager.Instance().setRemoteVideoWindow(application.getMEngine(), -1, null);//set
        if (remoteRenderScreen != null) {
            remoteRenderScreen.release();
        }

        CallManager.Instance().setShareVideoWindow(application.getMEngine(), -1, null);//set
    ...
    public void onHiddenChanged(boolean hidden) {
        ...
        if (hidden) {
            ...
            stopVideo(application.getMEngine());
        } else {
            updateVideo(application.getMEngine());
            activity.receiver.broadcastReceiver = this;
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.ibcamera) {
            ...
            application.setMUseFrontCamera(!application.getMUseFrontCamera());
            SetCamera(portSipLib, application.getMUseFrontCamera());
