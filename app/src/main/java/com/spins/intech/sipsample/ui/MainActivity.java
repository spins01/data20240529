...
public class MainActivity extends Activity implements RadioGroup.OnCheckedChangeListener {
    ...
    public final int REQ_DANGERS_PERMISSION = 2;
...
//    }
    ...
    public void onCheckedChanged(RadioGroup radioGroup, int checkedId) {
        if (checkedId == R.id.tab_login) {
            switchContent(R.id.login_fragment);
        }else if(checkedId == R.id.tab_numpad){
            switchContent(R.id.numpad_fragment);
        }else if(checkedId == R.id.tab_video){
            switchContent(R.id.video_fragment);
        }else if(checkedId == R.id.tab_message){
            switchContent(R.id.message_fragment);
        } else if (checkedId == R.id.tab_setting) {
