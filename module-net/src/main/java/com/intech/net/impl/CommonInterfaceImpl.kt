...
import com.intech.net.constant.commissioner_key
...
import com.intech.net.constant.status
...
class CommonInterfaceImpl : CommonInterface {
    override suspend fun login(
        userName: String,
        password: String,
        callback: CommonObjCallback<UserInfoBean>
    ) {
    ...
    override suspend fun search(
        ...
        startTime: String,
        endTime: String,
        callback: CommonListCallback<SearchBean>,
        commissioner: String?
    ) {
        val params = mutableMapOf(
            spinsUsername to userName,
            start_date to startTime,
            end_date to endTime,
            status to SearchBean.STATUS_NOT_DIALED // 未拨打
        )
        // 页面业务无此功能，暂时注释掉
//        if (!commissioner.isNullOrEmpty()) {
//            params[commissioner_key] = commissioner
//        }
